...
if(name == 1234){
    ...
    const address = dataValue[0].address.street + '\n'+ dataValue[0].address.city + '\n'+ dataValue[0].address.zipcode;
...
<Button style={styles.customBtnBG}
    ...
    const address = dataValue[1].address.street + '\n'+ dataValue[0].address.city + '\n'+ dataValue[0].address.zipcode;
...
<Button 
    ...
    const address = dataValue[2].address.street + '\n'+dataValue[0].address.city + '\n'+ dataValue[0].address.zipcode;
